...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( Recipe recipe)?  onTapFavorite,TResult Function()?  onTapIngredient,TResult Function()?  onTapProcedure,TResult Function( Recipe recipe)?  onTapFollow,TResult Function( int recipeId)?  loadRecipe,required TResult orElse(),}) {final _that = this;
switch (_that) {
case OnTapFavorite() when onTapFavorite != null:
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( Recipe recipe)?  onTapFavorite,TResult? Function()?  onTapIngredient,TResult? Function()?  onTapProcedure,TResult? Function( Recipe recipe)?  onTapFollow,TResult? Function( int recipeId)?  loadRecipe,}) {final _that = this;
switch (_that) {
case OnTapFavorite() when onTapFavorite != null:
return onTapFavorite(_that.recipe);case OnTapIngredient() when onTapIngredient != null:
return onTapIngredient();case OnTapProcedure() when onTapProcedure != null:
